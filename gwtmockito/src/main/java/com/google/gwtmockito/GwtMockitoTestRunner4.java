...
import com.google.gwtmockito.util.JavaSourceParser;
 ...
 * {@link GwtMockitoTestRunner4} will behave as follows:
 *
 * <ul>
 ...
 *      {@link GwtMockitoTestRunner4#getClassesToStub}.
 * </ul>
 *
 * @see GwtMockito
 * @author ekuefler@google.com (Erik Kuefler)
 */
public class GwtMockitoTestRunner4 extends BlockJUnit4ClassRunner {
   ...
   */
  public GwtMockitoTestRunner4(Class<?> unitTestClass) throws InitializationError {
    super(unitTestClass);
   ...
   * extending {@link GwtMockitoTestRunner4} and overriding this method. This allows users to
   ...
   * runner extending {@link GwtMockitoTestRunner4} and overriding this method.
   *
  ...
  private final class GwtMockitoClassLoader extends Loader implements Translator {
    ...
    GwtMockitoClassLoader(ClassLoader classLoader, ClassPool classPool) {
      super(classLoader == null ? GwtMockitoTestRunner4.class.getClassLoader() : classLoader, classPool);
      try {
    ...
    public void onLoad(ClassPool pool, String name)
      ...
      boolean lienzoStuff = false;
      try {
        lienzoStuff = doLienzoStuff(pool, name);
    ...
    private boolean doLienzoStuff(final ClassPool pool, final String name) throws NotFoundException, CannotCompileException, IOException, ParseException {
