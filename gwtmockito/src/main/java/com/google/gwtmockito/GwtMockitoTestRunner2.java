...
import com.google.gwtmockito.impl.JSStubGenerator;
 ...
 * {@link GwtMockitoTestRunner2} will behave as follows:
 *
 * <ul>
 ...
 *      {@link GwtMockitoTestRunner2#getClassesToStub}.
 * </ul>
 *
 * @see GwtMockito
 * @author ekuefler@google.com (Erik Kuefler)
 */
public class GwtMockitoTestRunner2 extends BlockJUnit4ClassRunner {
   ...
   */
  public GwtMockitoTestRunner2(Class<?> unitTestClass) throws InitializationError {
    super(unitTestClass);
   ...
   * extending {@link GwtMockitoTestRunner2} and overriding this method. This allows users to
   ...
   * runner extending {@link GwtMockitoTestRunner2} and overriding this method.
   *
  ...
  private final class GwtMockitoClassLoader extends Loader implements Translator {
    ...
    GwtMockitoClassLoader(ClassLoader classLoader, ClassPool classPool) {
      super(classLoader == null ? GwtMockitoTestRunner2.class.getClassLoader() : classLoader, classPool);
      try {
    ...
    public void onLoad(ClassPool pool, String name)
      ...
      boolean shouldStab = true;
      if ( "com.google.gwt.core.client.JavaScriptObject".equals(name) ) {
        JSStubGenerator.getEngine();
        System.out.println("Is JSO");
        CtMethod method = clazz.getDeclaredMethod("createObject");
        method.insertBefore("return (%o) com.google.gwtmockito.impl.JSStubGenerator.invoke(\"");
        method.insertAfter("\");");
        shouldStab = false;
      }
