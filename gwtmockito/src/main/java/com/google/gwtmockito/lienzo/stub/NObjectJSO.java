...
public class NObjectJSO extends JavaScriptObject {
    ...
    {
        System.out.println("Creating a custom Lienzo overlay type for [NObjectJSO]");
    }

    public static final com.ait.tooling.nativetools.client.NObjectJSO cast(final Object jso)
    {
        if (null != jso)
        {
            return (com.ait.tooling.nativetools.client.NObjectJSO) jso;
        }
        return null;
    }
